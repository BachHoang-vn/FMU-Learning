...
void setStartValues(ModelInstance *comp) {
    // input
    i(In_UserConfirmAirbagState)            = 0;         // Initial input value     (1)
    b(In_PassengerAirbagDisableLamp_bo)     = fmi2True;  // Initial input value     (2)
    b(In_PassengerAirbagEnableLamp_bo)      = fmi2True;  // Initial input value     (3)
    i(In_PassengerAirbagWarningState_se)    = 0;         // Initial input value     (4)
    // output
    i(Out_UserConfirmAirbagState_se)        = 0;         // Initial output value    (5)
    i(Out_PassengerAirbagWarningState_se)   = 0;         // Initial output value    (6)
    b(Out_PassengerAirbagDisableLamp_bo)    = fmi2False; // Initial output value    (7)
}
...
void calculateValues(ModelInstance *comp) {
    ...
    b(Out_PassengerAirbagDisableLamp_bo)    = b(In_PassengerAirbagDisableLamp_bo) && !b(In_PassengerAirbagEnableLamp_bo);
}
